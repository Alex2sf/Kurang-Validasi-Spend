...
public class MainForm extends javax.swing.JFrame {
    ...
    public void resetForm(){
      ...
      public int boolToInt(Boolean Spending) {
         store(); 
      return Spending.compareTo(false);
    ...
    public void store(){
        ...
        boolean Spending = "Spending".equals(cbType.getSelectedItem().toString());
        int p = this.saldo;
